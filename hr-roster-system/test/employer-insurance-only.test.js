...
assert.ok(riskService.includes('r.risk_type <> 3'), '历史社保风险仍会展示');
assert.ok(riskService.includes('s.employer_end_date IS NOT NULL AND s.employer_end_date<=:after30Days'), '未填写到期日仍会被误判为雇主险风险');
